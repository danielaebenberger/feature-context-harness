---
description: Pillar C — Persona-based UAT. Selects relevant Jahia personas, generates concrete UAT scenarios for each, performs synthetic walkthroughs where Cypress evidence is absent, and produces a persona-ucat-pack.md. Contains a mandatory human checkpoint before scenario execution.
argument-hint: <feature context: ticket, PRP plan, or PR description> [--feature <slug>]
---
