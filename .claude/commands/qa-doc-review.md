---
description: Pillar D — Documentation Review. Evaluates whether README, Academy, CHANGELOG, migration guide, API docs, and support docs reflect a feature's user-visible changes, producing a doc-review.md gap analysis. Requires a filled documentation sources form first.
argument-hint: --sources <slug>-doc-sources.md --feature <slug> [--diff <file>]
---
...
1. Fetch the page content (use the `WebFetch` tool if available, or the sensor)
