---
description: Pillar A — Acceptance Criteria Validation. Drafts ACs from a ticket/plan (REFINEMENT) or maps finalized ACs to test evidence (VALIDATION), producing an ac-matrix.md verdict. Always keeps a QA engineer in the loop.
argument-hint: [ticket URL | PRP plan path | PR diff] [--mode refine|validate]
---
