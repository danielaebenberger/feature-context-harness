---
description: Pillar B — Test Adequacy Review. Analyzes the Cypress suite for scenario, AC, persona, multilingual, permission, and accessibility coverage beyond line coverage, producing a test-adequacy-review.md with findings and recommendations.
argument-hint: --tests-dir <path> [--feature <slug>] [--ac-matrix <file>]
---
